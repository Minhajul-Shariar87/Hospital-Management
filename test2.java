...
public class test2 {
    ...
    public static void main(String[] args) {
      /* */  try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital management", "root", ""); //Establishing a Connection
            ...
            ResultSet rs = st.executeQuery("select * from table2");//Executing the SQL Query
            while (rs.next()) {//moves the cursor to the next row of the result set. If there are no more rows, it returns false, terminating the loop.
                ...
                System.out.println("District=" + rs.getString(3) );
